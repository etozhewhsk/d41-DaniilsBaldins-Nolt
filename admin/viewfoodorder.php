...
<body>
    ...
    <?php include_once('includes/leftbar.php');?>
        ...
        <div class="row border-bottom">
            ...
            <div class="col-lg-10">
                <h2>Pasūtījums #<?php echo $_GET['orderid'];?></h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="dashboard.php">Sākumlapa</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a>Pasūtījuma detaļas</a>
                    </li>
...
<td colspan="2" style="font-size:20px;color:blue">
  ...
  <tr>
    <th>Dzīvokļa/Ēkas numurs.</th>
    <td><?php  echo $row['Flatnobuldngno'];?></td>
  </tr>
  <tr>
    <th>Ielas nosaukums</th>
  ...
  <tr>
    <th>Pasūtījuma galīgais statuss</th>
    <td> <?php  
...
$cnt=$cnt+1;} ?>
<tr>
  <th colspan="3" style="text-align:center">Kopsumma </th>
...
<tr>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
    ...
    <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-primary">Atjaunināt pasūtījumu</button></td>
  </tr>
</form>
  <?php } ?>
