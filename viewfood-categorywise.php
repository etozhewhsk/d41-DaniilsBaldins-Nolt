...
if($query)
{
 echo "<script>alert('Pievienots grozam');</script>";
} else {
 echo "<script>alert('Kļūda, vēlāk mēģiniet vēlreiz.');</script>";
}
}
                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                    <div class="sidebar-title white-txt">
                                        <h6>Meklēt</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="Meklēt" name="searchdata" id="searchdata"> <span class="input-group-btn">
...
<ul class="pagination" >
        <li class="page-link"><a href="?pageno=1">Pirmaja</a></li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-link">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>">Iepriekšējā</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-link">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>">Nākamaja</a>
        </li>
        <li class="page-link"><a href="?pageno=<?php echo $total_pages; ?>">Pēdēja</a></li>
    </ul>
