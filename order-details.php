                        ...
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                                    Jūsu pasūtījums: <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-3">
                        <div class="sidebar-wrap">
                            <div class="widget widget-cart">
                                <div class="widget-heading">
                                    <h3 class="widget-title text-dark">
                                        Pasūtījums #<?php echo $oid;?> detaļas
                              </h3>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="order-row bg-white">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-lg-12">
<p><b>Datums:</b> <?php echo $row['OrderTime']?></p>
<hr />
<p><b>Dzīvokļa/Ēkas numurs:</b> <?php echo $row['Flatnobuldngno']?></p>
 <p><b>Ielas nosaukums: </b> <?php echo $row['StreetName']?></p>
   <p><b>Durvju kods:</b> <?php echo $row['Code']?></p>
    <p><b>Pilsēta:</b> <?php echo $row['City']?></p>
...
?>
 ...
 <a href="javascript:void(0);" onClick="popUpWindow('invoice.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Rēķins" style="color:#fff">Rēķins</a></p>

    <p style="color:red">
        <a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Atcelt pasūtījumu" style="color:red">Atcelt pasūtījumu </a>
    </p>
...
if($status==''){
 echo "Gaidām apstiprinājumu";
} else{
 ?>

        <p name="status" class="btn theme-btn btn-lg">
<a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Meklēt sūtījumu" style="color:#fff">
