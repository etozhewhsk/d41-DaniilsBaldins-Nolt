...
if(isset($_POST['submit']))
  {
    ...
    if($result>0){
$msg="Šis e-pasts vai kontaktpersonas numurs jau ir saistīts ar citu kontu";
    }
    else{
    ...
    if ($query) {
    $msg="Jūs esat veiksmīgi reģistrējies";
  }
  else
    {
...
{
alert('Lauks Parole un Atkārtot paroli neatbilst');
                              ...
                              <form action="" name="signup" method="post" onsubmit="return checkpass();">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" value="" id="mobilenumber" name="mobilenumber" required="true" maxlength="8" pattern="[0-9]{8}">
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">Atkārtojiet paroli</label>
