                            ...
                            <div class="sidebar clearfix m-b-20">
                                <div class="main-block">
                                    <div class="sidebar-title white-txt">
                                        <h6>Kategorija</h6> <i class="fa fa-cutlery pull-right"></i> </div>
...
?>
 <a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Track order">Statuss</a></li>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                     ...
                                     <a href="order-details.php?orderid=<?php echo $row['Ordernumber'];?>" class="btn theme-btn-dash">Detaļas</a> </div>
                                        </div>
                                    </div>
                                </div>
                                <hr />
