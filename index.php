...
if($query)
{
 echo "<script>alert('Pievienots grozā');</script>";
} else {
 echo "<script>alert('Kaut kas nogāja greizi');</script>";
}
}
        ...
        <section class="hero bg-image" data-image-src="images/fast-food-e21500cbfa.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Nolt</h1>
                    <h5 class="font-white space-xs">Pasūtiet sapņaino ēdienu!</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-food.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Šodien es gribu....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="Šodien es gribu...."> </div>
                            </div>
                            <button onclick="location.href='search-food.php'" type="submit" name="search" class="btn theme-btn btn-lg">Meklēt</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Izveleties virtuvi</h4> </div>
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Pasutiet</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Populārs šajā mēnesī jūsu pilsētā</h2>
                    <p class="lead">Ātrās ēdināšanas piegāde</p>
                </div>
...
$ret=mysqli_query($con,"select * from tblfood order by rand() limit 3");
$cnt=1;
...
<a href="login.php" class="btn theme-btn-dash pull-right">Pasūtīt</a>
<?php } else {?>
    <form method="post"> 
    <input type="hidden" name="foodid" value="<?php echo $row['ID'];?>">   
<button type="submit" name="submit" class="btn theme-btn-dash pull-right">Pasūtīt</button>
  </form> 
<?php }?> </div>
                            </div>
